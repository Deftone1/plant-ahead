        ...
        .map((tree) => (
            ...
            <div className="col mb-4 " key={tree.key} >
                <div className="card" >
                    ...
                    {!tree.image_url && (<img src={Plant} className="card-img-top mx-auto border rounded img-thumbnail img-fluid mt-2" style={{ width: "200px", maxHeight: "200px", objectFit: "contain" }} alt={tree.name} />
                    
                    )
                    }

                    {tree.image_url && (<img src={tree.image_url} className="card-img-top mx-auto border rounded img-thumbnail img-fluid mt-2" style={{ width: "250px", maxHeight: "200px", objectFit: "cover" }} alt={tree.name} />
                    )
                    }
